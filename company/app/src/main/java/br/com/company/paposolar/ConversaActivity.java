...
import br.com.company.paposolar.Adapters.MensagensAdapter;
import br.com.company.paposolar.Beans.Conversa;
import br.com.company.paposolar.Beans.Mensagem;
import br.com.company.paposolar.Beans.Status;
import br.com.company.paposolar.Beans.UserType;
...
public class ConversaActivity extends AppCompatActivity implements Response.Listener<JSONObject>, Response.ErrorListener, Emitter.Listener  {
    ...
    private void sendMessage(final String messageText, final UserType userType)
    {
        ...
        message.setNomeText("Papo Solar");

        chatMessages.add(message);

        JSONObject j = new JSONObject();
        try {
            j.put("nome","Papo Solar");
    ...
    public void call(final Object... args) {
        getActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    if(data.getString("user_id").equals("1") || data.getString("user_receiver_id").equals("1")) {
                        if (data.getString("user_id").equals("1")) {
